...
This example shows how to use the TK52 - 8×8 Matrix LED module (MAX7219 driver) on an Arduino Uno R3 to display various patterns.
...
// Note: to cascade more 8×8 modules, increase the number of devices (the last argument)
...
- **`LedControl lc = LedControl(DIN_PIN, CLK_PIN, CS_PIN, 1)`:** Create LedControl object using software SPI; `1` indicates a single 8×8 module (to chain more modules, increase this number).
